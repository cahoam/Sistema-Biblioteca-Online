...
<selection class="background-emprestimo">
  ...
  <div class="container container-bg col-xs-3 col-sm-3 col-md-3 col-lg-3 borda">
    <div class="row">
      ...
      <div class="col-sm">
        <div class="container">
          <form action="actionEmprestimo.php" method="POST">
            <center><img src="imgs/emprestimo.png" class="row justify-content-center" width="100" height="100"></center>
            <h5 class="card-title text-center text-white">Preencha corretamente os campos abaixo para empréstimo</h5>
            ...
            <?php
              error_reporting(0);
              //Verifica o status de actionEmprestimo.php 
              if($_SESSION['verificaEmprestimoRepitido'] == "true"){
                echo '';
                echo '
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                Livro já alugado pelo usuário!
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
                </div>
                ';
                $_SESSION['verificaEmprestimoRepitido'] = "false";
              }else{
              
                  if($_SESSION['verificaEmprestimoUser'] == "true"){
                    echo '';
                    echo '
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    ';
                    $_SESSION['verificaEmprestimoUser'] = "false";
                  }else{
                    if($_SESSION['verificaEmprestimo']=="true"){
                      echo '';
                      echo '
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    }if($_SESSION['verificaEmprestimoLivro']=="empty"){
                      echo '';
                      echo '
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                      ...
                      ';
                      $_SESSION['verificaEmprestimoLivro'] = "false";
                    }else{
                    }
                  }
              }
